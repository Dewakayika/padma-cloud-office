...
<div class="bg-white rounded-lg p-4">
    <div class="flex items-center mb-6">
        ...
        <div>
            <h1 class="text-2xl font-semibold">SOP Setup</h1>
            <p class="text-gray-600">Manage Standard Operating Procedures for project types</p>
        </div>
    </div>
        ...
        @forelse($projectTypes as $projectType)
            <div class="border rounded-lg p-4 hover:shadow-md transition-shadow">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="text-lg font-medium text-gray-900">{{ $projectType->project_name }}</h3>
                        <p class="text-gray-600">Rate: ${{ number_format($projectType->project_rate, 2) }}</p>
                    </div>
                    <div>
