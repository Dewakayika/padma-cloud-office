...
@php
    ...
    $assignTimestamp = $assignTimestamp ? \Carbon\Carbon::parse($assignTimestamp) : null;
    $doneTimestamp = $doneTimestamp ? \Carbon\Carbon::parse($doneTimestamp) : null;
    $totalTime = $assignTimestamp && $doneTimestamp ? $assignTimestamp->diffInSeconds($doneTimestamp) : 0;
