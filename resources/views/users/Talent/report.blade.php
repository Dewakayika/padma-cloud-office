            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-8 max-w-md mx-4">
                <div class="text-center">
                    <div class="mb-6">
                        ...
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Under Development</h1>
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                            <p class="text-sm text-blue-800 dark:text-blue-200">
                                <strong>What's coming:</strong> Comprehensive reports with detailed analytics, performance metrics, financial insights, and quality assessments.
                            </p>
                        </div>
                    </div>
        ...
        <div class="py-4">
            ...
            <div x-show="activeTab === 'overview'" x-cloak>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Project Completion Trend</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Monthly project completion for the past 6 months</p>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Project Type Distribution</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Breakdown of projects by type for May 2025</p>
                        <div style="height: 300px; position: relative;">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm mt-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button type="button" class="inline-flex items-center gap-2 px-3 py-2 text-sm text-gray-700 bg-white dark:bg-gray-900 dark:border-gray-700 dark:text-white border border-gray-300 rounded-lg hover:bg-gray-50">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between py-4 border-b border-gray-100">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="text-sm font-medium text-gray-900 dark:text-white">Keiken Ninzu - Episode 49</h4>
                            ...
                            <div class="flex items-center gap-4">
                                <div class="text-right">
                                    <span class="block text-sm font-medium text-gray-900 dark:text-white">$850</span>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">Revenue</span>
                                </div>
                                <button type="button" class="inline-flex items-center text-sm text-gray-700 dark:text-white dark:bg-gray-900 dark:border-gray-700 border border-gray-300 rounded-lg px-3 py-2 hover:text-gray-900">
                        ...
                        <div class="flex items-center justify-between py-4 border-b border-gray-100">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="text-sm font-medium text-gray-900 dark:text-white">Stellar Odyssey - Space Station</h4>
                            ...
                            <div class="flex items-center gap-4">
                                <div class="text-right">
                                    <span class="block text-sm font-medium text-gray-900 dark:text-white">$720</span>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">Revenue</span>
                                </div>
                                <button type="button" class="inline-flex items-center text-sm text-gray-700 dark:text-white dark:bg-gray-900 dark:border-gray-700 border border-gray-300 rounded-lg px-3 py-2 hover:text-gray-900">
                                    <svg class="w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div class="flex items-center justify-between py-4 border-b border-gray-100">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="text-sm font-medium text-gray-900 dark:text-white">Urban Legends - Chapter 3</h4>
                            ...
                            <div class="flex items-center gap-4">
                                <div class="text-right">
                                    <span class="block text-sm font-medium text-gray-900 dark:text-white">$650</span>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">Revenue</span>
                                </div>
                                <button type="button" class="inline-flex items-center text-sm text-gray-700 dark:text-white dark:bg-gray-900 dark:border-gray-700 border border-gray-300 rounded-lg px-3 py-2 hover:text-gray-900">
                                    <svg class="w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div class="flex items-center justify-between py-4">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="text-sm font-medium text-gray-900 dark:text-white">Dragon Realm - Episode 12</h4>
                            ...
                            <div class="flex items-center gap-4">
                                <div class="text-right">
                                    <span class="block text-sm font-medium text-gray-900 dark:text-white">$580</span>
                                    <span class="text-xs text-gray-500 dark:text-gray-400">Revenue</span>
                                </div>
                                <button type="button" class="inline-flex items-center text-sm text-gray-700 dark:text-white dark:bg-gray-900 dark:border-gray-700 border border-gray-300 rounded-lg px-3 py-2 hover:text-gray-900">
                                    <svg class="w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <div x-show="activeTab === 'performance'" x-cloak>
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Detailed performance analysis for May 2025</p>
                    </div>

                    {{-- Efficiency Metrics --}}
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Efficiency Metrics</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {{-- Avg. Completion Time --}}
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Avg. Completion Time</p>
                                <p class="text-2xl font-semibold text-gray-900 dark:text-white mb-1">3.8 days</p>
                                <p class="text-sm text-green-600 dark:text-green-400">↑ 8% faster than last period</p>
                            </div>
                            {{-- On-Time Delivery --}}
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">On-Time Delivery</p>
                                <p class="text-2xl font-semibold text-gray-900 dark:text-white mb-1">98.3%</p>
                                <p class="text-sm text-green-600 dark:text-green-400">↑ 2.1% higher than last period</p>
                            </div>
                            {{-- Revision Rate --}}
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Revision Rate</p>
                                <p class="text-2xl font-semibold text-gray-900 dark:text-white mb-1">5.2%</p>
                                <p class="text-sm text-green-600 dark:text-green-400">↑ 3.1% lower than last period</p>
                            </div>
                            {{-- Productivity --}}
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Productivity</p>
                                <p class="text-2xl font-semibold text-gray-900 dark:text-white mb-1">+15%</p>
                                <p class="text-sm text-green-600 dark:text-green-400">↑ 5% higher than last period</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Project Type Performance</h3>
                        <div class="space-y-4">
                            {{-- Character Design --}}
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Character Design</span>
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Avg. Completion: 3.5 days</span>
                                </div>
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Background Art</span>
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Avg. Completion: 4.2 days</span>
                                </div>
                                <div class="h-2 bg-gray-200 rounded-full">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Storyboarding</span>
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Avg. Completion: 2.8 days</span>
                                </div>
                                <div class="h-2 bg-gray-200 rounded-full">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Coloring</span>
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Avg. Completion: 3.2 days</span>
                                </div>
                                <div class="h-2 bg-gray-200 rounded-full">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Performance Comparison</h3>
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="text-sm">
                                    <tr class="border-t border-gray-200">
                                        <td class="py-3 text-gray-600 dark:text-gray-400">Completion Time</td>
                                        <td class="py-3 text-gray-900 dark:text-white">3.8 days</td>
                                        <td class="py-3 text-gray-900 dark:text-white">4.5 days</td>
                                        <td class="py-3 text-green-600 dark:text-green-400">-0.7 days (15.6% faster)</td>
                                    </tr>
                                    <tr class="border-t border-gray-200">
                                        <td class="py-3 text-gray-600 dark:text-gray-400">Quality Score</td>
                                        <td class="py-3 text-gray-900 dark:text-white">9.2/10</td>
                                        <td class="py-3 text-gray-900 dark:text-white">8.7/10</td>
                                        <td class="py-3 text-green-600 dark:text-green-400">+0.5 (5.7% higher)</td>
                                    </tr>
                                    <tr class="border-t border-gray-200">
                                        <td class="py-3 text-gray-600 dark:text-gray-400">Client Satisfaction</td>
                                        <td class="py-3 text-gray-900 dark:text-white">4.8/5</td>
                                        <td class="py-3 text-gray-900 dark:text-white">4.5/5</td>
                                        <td class="py-3 text-green-600 dark:text-green-400">+0.3 (6.7% higher)</td>
                                    </tr>
                                    <tr class="border-t border-gray-200">
                                        <td class="py-3 text-gray-600 dark:text-gray-400">Revision Rate</td>
                                        <td class="py-3 text-gray-900 dark:text-white">5.2%</td>
                                        <td class="py-3 text-gray-900 dark:text-white">8.3%</td>
                                        <td class="py-3 text-green-600 dark:text-green-400">-3.1% (37.3% lower)</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div x-show="activeTab === 'financial'" x-cloak>
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                            <div class="flex flex-col">
                                ...
                                <h2 class="text-sm font-medium text-gray-500 dark:text-gray-400">Avg. Project Value</h2>
                                <div class="mt-1">
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-white">$700</p>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                            <div class="flex flex-col">
                                ...
                                <h2 class="text-sm font-medium text-gray-500 dark:text-gray-400">Pending Payments</h2>
                                <div class="mt-1">
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-white">$2,800</p>
                                    <p class="text-sm text-yellow-600 dark:text-yellow-400">3 projects pending</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                            <div class="flex flex-col">
                                ...
                                <h2 class="text-sm font-medium text-gray-500 dark:text-gray-400">Payment Success Rate</h2>
                                <div class="mt-1">
                                    <p class="text-2xl font-semibold text-gray-900 dark:text-white">98.5%</p>
                                    <p class="text-sm text-green-600 dark:text-green-400">+2.5% from last month</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Revenue Breakdown --}}
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Revenue by Project Type</h3>
                        <div class="space-y-4">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">$5,200</span>
                                </div>
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">$3,600</span>
                                </div>
                                <div class="h-2 bg-gray-100 rounded-full">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">$2,150</span>
                                </div>
                                <div class="h-2 bg-gray-100 rounded-full">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">$1,500</span>
                                </div>
                                <div class="h-2 bg-gray-100 rounded-full">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Monthly Revenue Trend</h3>
            ...
            <div x-show="activeTab === 'quality'" x-cloak>
                <div class="space-y-6">
                    {{-- Header --}}
                    <div>
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Quality Metrics</h2>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Quality assessment for May 2025</p>
                    </div>

                    {{-- Quality Scores by Project Type --}}
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Quality Scores by Project Type</h3>
                        <div class="space-y-4">
                            {{-- Character Design Score --}}
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Character Design</span>
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">9.4/10</span>
                                </div>
                                <div class="h-2 bg-gray-100 rounded-full">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Background Art</span>
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">8.7/10</span>
                                </div>
                                <div class="h-2 bg-gray-100 rounded-full">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Storyboarding</span>
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">8.9/10</span>
                                </div>
                                <div class="h-2 bg-gray-100 rounded-full">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Client Feedback Highlights</h3>
                        <div class="space-y-6">
                            {{-- Feedback Item 1 --}}
                            <div class="space-y-2 border-b border-gray-200 dark:border-gray-700 pb-2">
                                <div class="flex items-center gap-3">
                                    <span class="px-2 py-1 text-xs font-medium text-purple-700 bg-purple-50 rounded-full">Character Design</span>
                                    <span class="font-medium text-gray-900 dark:text-white">Keiken Ninzu - Episode 49</span>
                                </div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 italic">"Exceptional character expressions and attention to detail. The dynamic poses really capture the essence of the action scenes."</p>
                            </div>
                            ...
                            <div class="space-y-2 border-b border-gray-200 dark:border-gray-700 pb-2">
                                <div class="flex items-center gap-3">
                                    <span class="px-2 py-1 text-xs font-medium text-blue-700 bg-blue-50 rounded-full">Background Art</span>
                                    <span class="font-medium text-gray-900 dark:text-white">Stellar Odyssey - Space Station</span>
                                </div>
                                <div class="flex text-yellow-400">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 italic">"The perspective and lighting in the space station scenes are outstanding. Creates a perfect atmosphere for the story."</p>
                            </div>
                            ...
                            <div class="space-y-2 border-b border-gray-200 dark:border-gray-700 pb-2">
                                <div class="flex items-center gap-3">
                                    <span class="px-2 py-1 text-xs font-medium text-green-700 bg-green-50 rounded-full">Storyboarding</span>
                                    <span class="font-medium text-gray-900 dark:text-white">Urban Legends - Chapter 3</span>
                                </div>
                                <div class="flex text-yellow-400">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 italic">"The pacing and panel layout for the chase sequence was brilliantly executed. Really enhances the tension in the story."</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Quality Improvement Areas</h3>
                        <div class="space-y-4">
                            <div class="border-b border-gray-200 dark:border-gray-700 pb-2">
                                <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-1">Background Consistency</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Ensure consistent lighting and perspective across all background scenes, especially in multi-episode projects.</p>
                            </div>
                            <div class="border-b border-gray-200 dark:border-gray-700 pb-2">
                                <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-1">Character Proportions</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Maintain consistent character proportions across different poses and angles, particularly in action sequences.</p>
                            </div>
                            <div class="border-b border-gray-200 dark:border-gray-700 pb-2">
                                <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-1">Color Palette Cohesion</h4>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Ensure color palettes remain cohesive across scenes and maintain the established mood of the project.</p>
                            </div>
                        </div>
                    </div>
                </div>
