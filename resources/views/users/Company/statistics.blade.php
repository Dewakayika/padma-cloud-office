                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                            <p class="text-sm text-blue-800 dark:text-blue-200">
                                <strong>What's coming:</strong> Comprehensive company statistics with detailed analytics, performance metrics, project insights, and talent performance tracking.
                            </p>
                        </div>
                    </div>
